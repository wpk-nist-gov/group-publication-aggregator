...
PACKAGE_NAME = "group-publication-aggregator"
IMPORT_NAME = "group_publication_aggregator"
KERNEL_BASE = "group_publication_aggregator"
...
def dev(
    ...
    session.run(
        ...
        "--user",
        "--name",
        "group-publication-aggregator-dev",
        "--display-name",
        "Python [venv: group-publication-aggregator-dev]",
    )
