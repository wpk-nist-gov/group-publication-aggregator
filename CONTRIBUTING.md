...
[issues]: https://github.com/wpk-nist-gov/group-publication-aggregator/issues
<!-- prettier-ignore-end -->
...
- Clone your fork locally:
  ...
  ```bash
  git clone git@github.com:your_name_here/group-publication-aggregator.git
  ```
  ...
  ```bash
  git clone --recursive-submodules git@github.com:your_name_here/group-publication-aggregator.git
  ```

  or after the clone using

  ```bash
  cd group-publication-aggregator
